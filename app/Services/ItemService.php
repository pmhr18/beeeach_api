...
class ItemService
{
    public function searchItems($request)
    {
        ...
        $items = ShowItemsResource::collection(Item::find($itemIds));
    ...
    public function getInitialData()
    {
        ...
        $initialData = [
            'brewery' => ArrayDataResource::collection($brewery),
            'country' => ArrayDataResource::collection($country),
            'prefecture' => ArrayDataResource::collection($prefecture),
            'taste' => ArrayDataResource::collection($taste),
            'container' => ArrayDataResource::collection($container),
            'style' => ArrayDataResource::collection($style),
            'color' => ArrayDataResource::collection($color),
            'abv' => ArrayDataResource::collection($abv),
            'type' => ArrayDataResource::collection($type),
        ];
